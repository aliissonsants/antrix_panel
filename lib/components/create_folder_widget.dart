            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      retun = await CreateFolderCall.call(
                        name: textController!.text,
                      );

                      final streamTapeCreateData = createStreamTapeRecordData(
                        dirName: textController!.text,
                        dirID: getJsonField(
                          (retun?.jsonBody ?? ''),
                          r'''$.result.folderid''',
                        ).toString(),
                      );
                      await StreamTapeRecord.collection
                          .doc()
                          .set(streamTapeCreateData);
